...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal tp 'X' the x.png is placed in HTML
        ...
        checkWinConditions();
        //This condtition is for changing the active player.
        if (activePlayer === 'X') {
    ...
    //This function results in a random being square being selected by the computer.
 ...
 //drawLine() function is called to draw a line on the screen if the conditioin is met.
 function checkWinConditions() {
    ...
    //This condition checks for a tie. If noone of the above conditions are met and 
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 varables we pass are all included in our array then
 ...
 function disableClick() {
    ...
    //This makes our body clickablkle again after 1 second.
 ...
 function audio(audioURL) {
    //We create a new audio object and we pass he path as parameter.
 ...
 function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    disableClick();
    //This line plays thr win sounds.
    audio('./media/winner1.mp3');
